...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual(['ask_user_question', 'bash', 'bash', 'code_explain', 'code_outline', 'code_review', 'cordis_define', 'cordis_inspect_list', 'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop', 'cordis_undefine', 'create_goal', 'dependency_graph', 'diff_merge', 'edit', 'exit_plan_mode', 'get_goal', 'github_file_read', 'github_issue_create', 'github_issue_list', 'github_pr_create', 'github_search_code', 'glob', 'grep', 'interrupt_agent', 'job_kill', 'job_list', 'job_output', 'list_agents', 'lsp', 'pwsh', 'ralph', 'read', 'read_image', 'report', 'run_code', 'schedule_create', 'schedule_delete', 'schedule_list', 'semantic_search', 'send_message', 'session_event_read', 'session_event_search', 'session_event_trace', 'session_search', 'session_trace', 'skill', 'str_replace_editor', 'subagent', 'terminal_close', 'terminal_list', 'terminal_open', 'terminal_read', 'terminal_send', 'terminal_signal', 'test_impact', 'todo_write', 'update_goal', 'web_fetch', 'web_search', 'workflow', 'workflow_run', 'write'])
