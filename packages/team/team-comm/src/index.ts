...
/** Parse only the last `n` records of a JSONL file without parsing the bulk — *  used for the cheap dedup window and reply lookups on a long inbox. */
...
export function apply(ctx: Context): void {
  ...
  ctx.systemPrompt.section({
    ...
    text:
      ...
      + 'Example: if you told 2号to research, and 2号replied, NOW send the result to 3号without waiting. '
